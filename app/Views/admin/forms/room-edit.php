...
<form method="POST" enctype="multipart/form-data">
    ...
    <label>Lantai</label>
    <input type="number" name="lantai" min="1" value="<?php echo e($room['lantai']); ?>" required>

    <label>Fasilitas</label>
    <textarea name="fasilitas" rows="3"><?php echo e($room['fasilitas']); ?></textarea>

    <label>Deskripsi Detail Kamar</label>
    <textarea name="deskripsi_kamar" rows="5" placeholder="Jelaskan kondisi dan keunggulan khusus kamar ini."><?php echo e($room['deskripsi_kamar'] ?? ''); ?></textarea>

    <label>Harga</label>
    <input type="number" name="harga" min="1" value="<?php echo e($room['harga']); ?>" required>

    <label>Diskon Khusus Kamar (%)</label>
    <input type="number" name="diskon_persen" min="0" max="100" value="<?php echo e($room['diskon_persen'] ?? 0); ?>" required>
