...
<form method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="nomor_kamar" class="form-control" placeholder="Contoh: A1 atau 101" required>

    <label>Lantai</label>
    <input type="number" name="lantai" min="1" class="form-control" required>

    <label>Fasilitas</label>
    <textarea name="fasilitas" class="form-control" placeholder="AC, Wifi, KM Dalam..."></textarea>

    <label>Deskripsi Detail Kamar</label>
    <textarea name="deskripsi_kamar" rows="5" class="form-control" placeholder="Jelaskan ukuran kamar, kondisi ruangan, pencahayaan, aturan khusus, dan informasi penting lainnya."></textarea>
    ...
    <button type="submit" name="simpan" class="btn btn-primary">Simpan Kamar</button>
